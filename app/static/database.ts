/**
 * this is an entry point for a fake database instead of using a real database, which requires more configuration that is not actually needed for this project
 */
export default Object.freeze({
    social: {
        email: "willphan1712@gmail.com",
